...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ⚡', url=f"https://t.me/PriyaMovies_Group"),
            ],
            [
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 𝐉𝐎𝐈𝐍 𝐔𝐏𝐃𝐀𝐓𝐄𝐒 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 🔥", url=invite_link.invite_link
                )
            ]
        ]
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('For More Movies/updates', url='https://t.me/Sai_File_Store_Cu') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
